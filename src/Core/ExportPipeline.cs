...
namespace CryptoProExport
{
    ...
    public sealed class ExportPipeline
    {
        ...
        /// Запущенная утилита КриптоПро и изолированный worker rtCOMLite снимаются вместе
        /// с деревом процессов; APDU/PKCS#11 проверяют токен между нативными вызовами.
        /// </summary>
