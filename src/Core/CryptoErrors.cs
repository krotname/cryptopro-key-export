...
namespace CryptoProExport
{
    ...
    public static class CryptoErrors
    {
        private static readonly Dictionary<uint, string> Known = new Dictionary<uint, string>
        {
            ...
            [0x8010006B] = "SCARD_W_CARD_NOT_AUTHENTICATED: не выполнена авторизация на носителе",
            [0x8010006C] = "SCARD_W_WRONG_CHV: неверный PIN-код",
            [0x8010006D] = "SCARD_W_CHV_BLOCKED: PIN-код заблокирован, нужен разблокирующий код",
