...
| Встроенное руководство | ✅ работает | вшито ресурсом: кнопка «Справка» и команда `help`; 21 тест следит за разделами и шириной строк |
| Юнит-тесты | ✅ 85 тестов | `dotnet test`, зелёные локально и в CI |
...
- [x] Unit-тесты `Core` — 85 тестов: кодеки, `name.key`, аргументы и маскирование `P12Utility`, разбор PE, вшитые зависимости, `ContainerStore`, встроенное руководство, разрядность в отчёте.
- [x] Встроенная документация — `src/Core/guide.txt` вшит ресурсом: окно «Справка» и команда `help`, ничего внешнего не нужно.
